var colors = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"],
  dataColors = $("#total-assets-chart").data("colors"),
  options1 = {
  ...
  colors =
    (new ApexCharts(
      document.querySelector("#total-assets-chart"),
      options1
    ).render(),
    ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"]),
  dataColors = $("#book-value-chart").data("colors"),
  options2 = {
  ...
  colors =
    (new ApexCharts(
      document.querySelector("#book-value-chart"),
      options2
    ).render(),
    ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"]),
  dataColors = $("#depresiasi-chart").data("colors"),
  options3 = {
    chart: { type: "line", height: 60, sparkline: { enabled: !0 } },
  ...
  colors =
    (new ApexCharts(
      document.querySelector("#depresiasi-chart"),
      options3
    ).render(),
    ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"]),
  ...
  options = {
    chart: { height: 338, type: "line", toolbar: { show: !1 } },
