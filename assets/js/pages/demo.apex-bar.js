var colors = ["#39afd1"],
  ...
  options = {
    ...
    series: [
      {
        data: [
          138100000000, 26880000000, 154005040000, 95400000000, 66600666000,
          98152000000, 101500000000, 121000000000, 132000000000, 149000000000,
        ],
      },
    ],
    ...
    xaxis: {
      categories: [
        "LC00 - HO Pertamina Lubricants",
        "L111 - DSP Medan",
        "L114 - DSP Batam",
        "L401 - DSP Semarang",
        "L603 - DSP Tarakan",
        "L706 - DSP Jayapura",
        "Lab PUC - Laboratorium Production Unit Cilacap",
        "L302 - DSP Ujung Berung",
        "L604 - DSP Banjarmasin",
        "L311 - DSP Lebak",
      ],
    },
